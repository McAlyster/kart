...
class Artwork(Production):
    ...
    galleries = SortedManyToManyField(Gallery, blank=True, related_name="artworks_process")
    ...
    def __str__(self):
        authors = (
            ", ".join([author.__str__() for author in self.authors.all()])
...
class Event(Production):
    ...
    # artwork types
    installations = models.ManyToManyField(Installation, blank=True, related_name="hosting_events")
    films = models.ManyToManyField(Film, blank=True, related_name="hosting_events")
    performances = models.ManyToManyField(Performance, blank=True, related_name="hosting_events")
